...
export function parseExcelAnalysisSnapshot(raw) {
  ...
  try {
    ...
    return {
      ...
      chatScopeMode: parsed.chatScopeMode === "workbook" ? "workbook" : parsed.chatScopeMode === "sheets" ? "sheets" : "sheet",
      selectedAnalysisSheets: Array.isArray(parsed.selectedAnalysisSheets) ? parsed.selectedAnalysisSheets.filter((name) => typeof name === "string") : [],
