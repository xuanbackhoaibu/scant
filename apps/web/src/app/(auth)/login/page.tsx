...
import { FileText, Sparkles, ArrowRight, Lock, Mail, AlertCircle } from "lucide-react";
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      <div className="w-full max-w-md bg-white rounded-2xl border border-slate-200 shadow-sm p-8">
        ...
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <h1 className="text-xl font-bold text-slate-900">AI REPORT STUDIO</h1>
          <p className="text-xs text-slate-500 mt-1">Đăng nhập để vào không gian sáng tạo báo cáo VIP</p>
        </div>
